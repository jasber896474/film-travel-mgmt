...
function RomanNameCell({ last, first }) {
  const ln = (last || "").trim();
  const fn = (first || "").trim();
...
const staffColWidths = (withCheckbox) => (withCheckbox
  ? [32, 32, 68, 58, 64, 46, 36, 52, 52, 112, 84]
  : [32, 68, 58, 64, 46, 36, 52, 52, 112, 84]);
              ...
              <div style={{ overflowX: "auto" }}>
                <table style={tblW} className="data-table staff-table">
                  ...
                  <thead><tr style={thead}>
                    ...
                    <th style={{ ...thS, textAlign: "center" }}>{t.nameEnglish}</th>
                    ...
                    <th style={{ ...thS, textAlign: "left" }}>{t.dietNotes}</th>
                    ...
                    {rowsA.map((p, i) => {
                      ...
                      return (
                        <tr key={p.id} draggable={canEdit} onDragStart={() => { dragItem.current = persons.indexOf(p); }} onDragEnter={() => { dragOver.current = persons.indexOf(p); }} onDragEnd={handleDragEnd} onDragOver={(e) => e.preventDefault()}>
                          ...
                          <td style={tdS({ textAlign: "center", maxWidth: "none" })}><RomanNameCell last={p.last_roman} first={p.first_roman} /></td>
