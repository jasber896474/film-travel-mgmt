...
const T = {
  "zh-TW": {
    ...
    no: "編號", dept: "部門", nameKanji: "姓名（漢字）", nameEnglish: "姓名(英文)", nameRoman: "羅馬拼音", nameSurname: "姓", nameGiven: "名", importance: "重要度",
  ...
  "zh-CN": {
    ...
    no: "编号", dept: "部门", nameKanji: "姓名（汉字）", nameEnglish: "姓名(英文)", nameRoman: "罗马拼音", nameSurname: "姓", nameGiven: "名", importance: "重要度",
  ...
  en: {
    ...
    no: "No.", dept: "Dept", nameKanji: "Name", nameEnglish: "Name (English)", nameRoman: "Romanized", nameSurname: "Last", nameGiven: "First", importance: "Priority",
  ...
  ko: {
    ...
    no: "번호", dept: "부서", nameKanji: "이름", nameEnglish: "이름(영문)", nameRoman: "로마자", nameSurname: "성", nameGiven: "이름", importance: "중요도",
  ...
  ja: {
    ...
    no: "No.", dept: "部署", nameKanji: "氏名", nameEnglish: "氏名(英語)", nameRoman: "ローマ字", nameSurname: "姓", nameGiven: "名", importance: "重要度",
...
function staffCsvPersonHeaders(t) {
  return [t.no, t.dept, t.nameKanji, t.nameEnglish, t.importance, t.passport, t.dob, t.passportExp, t.dietNotes];
}
...
const staffColWidths = (withCheckbox) => (withCheckbox
  ? [36, 30, "9ch", "5.5em", "10%", "4%", "13ch", "8.5%", "8%", "18%", 100]
  : [30, "9ch", "5.5em", "10%", "4%", "13ch", "8.5%", "8%", "18%", 100]);
...
function ProjectApp({ project, userRole, user, isSystemOwner, lang, theme, onThemeChange, onLangChange, onBack, onProjectUpdate }) {
  ...
  const filterPersons = (q, dept) => persons.filter((p) => {
    ...
    const ok = !kw || [p.name_kanji, p.last_roman, p.first_roman, p.dept, p.passport].some((v) => (v || "").toLowerCase().includes(kw));
  ...
  const savePerson = async (f) => {
    try {
      const data = { ...f, dob: f.dob || null, passport_exp: f.passport_exp || null };
