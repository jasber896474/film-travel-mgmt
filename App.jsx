...
const T = {
  ...
  ko: {
    ...
    arranged: "완료", partial: "일부", unArranged: "미배정", passportWarn: "180일 미만",
  ...
  ja: {
    ...
    arranged: "手配済", partial: "一部", unArranged: "未手配", passportWarn: "残り180日未満",
...
function ProjectApp({ project, userRole, user, isSystemOwner, lang, theme, onThemeChange, onLangChange, onBack, onProjectUpdate }) {
  ...
  const getStatus = useCallback((id) => {
    ...
    const hasF = fl && fl.airline && fl.flight_no;
    const hasS = ps.some((s) => s.hotel_id && s.check_in && s.check_out);
