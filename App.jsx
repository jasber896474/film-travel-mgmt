...
const staffColWidths = (withCheckbox) => (withCheckbox
  ? [28, 28, "9ch", "5.5em", "11%", "5%", "12%", "8.5%", "8.5%", "24%", 92]
  : [28, "9ch", "5.5em", "11%", "5%", "12%", "8.5%", "8.5%", "24%", 92]);
  ...
  return (
    <style>{`
      ...
      *, *::before, *::after { box-sizing: border-box; }
      ...
      .staff-table-wrap { overflow-x: auto; width: 100%; max-width: 100%; padding: 0 4px 6px 0; -webkit-overflow-scrolling: touch; }
      .staff-table { width: 100%; max-width: 100%; }
      .staff-table th, .staff-table td { padding: 7px 8px; }
      ...
      .staff-table .col-diet { text-align: left; padding-left: 10px; padding-right: 12px; }
      .staff-table .col-actions { width: 92px; min-width: 92px; max-width: 92px; padding-left: 6px; padding-right: 12px; box-sizing: border-box; }
      .staff-table .col-actions .tbl-actions { display: inline-flex; flex-wrap: nowrap; gap: 5px; justify-content: center; max-width: 100%; }
