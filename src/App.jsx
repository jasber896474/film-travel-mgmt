...
// ─── i18n ──────────────────────────────────────────────────
const LANGS = { "zh-TW": "繁體中文", "zh-CN": "简体中文", en: "English", ko: "한국어" };

const T = {
  "zh-TW": {
    appName: "劇組交通住宿管理系統",
    logout: "登出", print: "列印", members: "成員管理", back: "返回",
    login: "登入", loginTitle: "請登入", loginEmail: "電子郵件", loginPw: "密碼", loginBtn: "登入", loginHint: "存取權限由管理員邀請授予",
    projects: "專案列表", newProject: "＋ 新增專案", openProject: "開啟 →", projectName: "專案名稱", projectDesc: "說明（選填）",
    create: "建立", creating: "建立中…", cancel: "取消", save: "儲存", saving: "儲存中…", edit: "編輯", delete: "刪除", add: "＋ 新增",
    ...
    arranged: "✓ 已安排", partial: "⚡ 部分完成", unArranged: "— 未安排",
    passportWarn: "⚠ 剩餘不足180天",
    ...
    checkedBag: "託運行李", cabinBag: "手提行李", flightDone: "✓ 已安排", flightNone: "未安排",
    addFlight: "＋ 輸入", editFlight: "編輯",
    ...
    addHotelTitle: "新增飯店", editHotelTitle: "編輯飯店",
    addRuleTitle: "新增房價規則", editRuleTitle: "編輯房價規則",
    targetHotel: "對象飯店",
    customRoomType: "自訂房型名稱",
    breakdownTitle: "每日房價明細",
    noData: "無資料", searchPlaceholder: "搜尋…",
    searchStaff: "搜尋姓名・部門・護照…", searchFlight: "搜尋姓名・航空公司…", searchHotel: "搜尋姓名・飯店…", searchHotelList: "搜尋飯店名・地址・電話…",
    allDept: "全部門", role_admin: "管理員", role_editor: "編輯", role_viewer: "唯讀",
    memberMgmt: "成員管理", inviteEmail: "電子郵件", inviteRole: "權限", invite: "邀請",
    currentMembers: "目前成員", langSetting: "語言設定", defaultLang: "預設語言",
    noProject: "尚無專案", noProjectHint: "建立新專案，或等待管理員邀請",
    firstProject: "＋ 建立第一個專案",
    deleteProjConfirm: "確定刪除此專案？所有相關資料也會一併刪除。",
    deleteConfirm: "確定刪除？",
    roleLabel: "身份",
  },
  "zh-CN": {
    appName: "剧组交通住宿管理系统",
    logout: "登出", print: "打印", members: "成员管理", back: "返回",
    login: "登录", loginTitle: "请登录", loginEmail: "电子邮件", loginPw: "密码", loginBtn: "登录", loginHint: "访问权限由管理员邀请授予",
    projects: "项目列表", newProject: "＋ 新建项目", openProject: "打开 →", projectName: "项目名称", projectDesc: "说明（选填）",
    create: "创建", creating: "创建中…", cancel: "取消", save: "保存", saving: "保存中…", edit: "编辑", delete: "删除", add: "＋ 新增",
    ...
    checkedBag: "托运行李", cabinBag: "手提行李", flightDone: "✓ 已安排", flightNone: "未安排",
    addFlight: "＋ 录入", editFlight: "编辑",
    ...
    addHotelTitle: "新增饭店", editHotelTitle: "编辑饭店",
    addRuleTitle: "新增房价规则", editRuleTitle: "编辑房价规则",
    targetHotel: "对象饭店",
    customRoomType: "自定义房型名称",
    breakdownTitle: "每日房价明细",
    noData: "无数据", searchPlaceholder: "搜索…",
    searchStaff: "搜索姓名・部门・护照…", searchFlight: "搜索姓名・航空公司…", searchHotel: "搜索姓名・饭店…", searchHotelList: "搜索饭店名・地址・电话…",
    allDept: "全部门", role_admin: "管理员", role_editor: "编辑", role_viewer: "只读",
    memberMgmt: "成员管理", inviteEmail: "电子邮件", inviteRole: "权限", invite: "邀请",
    currentMembers: "当前成员", langSetting: "语言设置", defaultLang: "默认语言",
    noProject: "暂无项目", noProjectHint: "创建新项目，或等待管理员邀请",
    firstProject: "＋ 创建第一个项目",
    deleteProjConfirm: "确定删除此项目？所有相关数据也会一并删除。",
    deleteConfirm: "确定删除？",
    roleLabel: "身份",
  },
  en: {
    appName: "Production Travel & Accommodation System",
    logout: "Logout", print: "Print", members: "Members", back: "Back",
    login: "Login", loginTitle: "Please Login", loginEmail: "Email", loginPw: "Password", loginBtn: "Login", loginHint: "Access is granted by invitation from admin",
    projects: "Projects", newProject: "+ New Project", openProject: "Open →", projectName: "Project Name", projectDesc: "Description (optional)",
    create: "Create", creating: "Creating…", cancel: "Cancel", save: "Save", saving: "Saving…", edit: "Edit", delete: "Delete", add: "+ Add",
    saved: "✓ Saved", deleted: "Deleted",
    tabStaff: "👤 Staff List", tabFlight: "✈ Flight Mgmt", tabHotel: "🏨 Hotel Mgmt", tabHotelList: "📋 Hotel List",
    staffList: "Staff List", flightMgmt: "✈ Flight Management", hotelMgmt: "Hotel Management", hotelList: "📋 Hotel List",
    no: "No.", dept: "Dept", nameKanji: "Name (Kanji)", nameRoman: "Romanized Name", importance: "Priority",
    status: "Status", passport: "Passport No.", dob: "Date of Birth", passportExp: "Passport Expiry", diet: "Dietary", action: "Actions",
    arranged: "✓ Arranged", partial: "⚡ Partial", unArranged: "— Pending",
    passportWarn: "⚠ Expires within 180 days",
    ...
    checkedBag: "Checked Bag", cabinBag: "Cabin Bag", flightDone: "✓ Arranged", flightNone: "Pending",
    addFlight: "+ Input", editFlight: "Edit",
    ...
    addHotelTitle: "Add Hotel", editHotelTitle: "Edit Hotel",
    addRuleTitle: "Add Pricing Rule", editRuleTitle: "Edit Pricing Rule",
    targetHotel: "Target Hotel",
    customRoomType: "Custom Room Type",
    breakdownTitle: "Daily Price Breakdown",
    noData: "No data", searchPlaceholder: "Search…",
    searchStaff: "Search name, dept, passport…", searchFlight: "Search name, airline…", searchHotel: "Search name, hotel…", searchHotelList: "Search hotel name, address…",
    allDept: "All Depts", role_admin: "Admin", role_editor: "Editor", role_viewer: "Viewer",
    memberMgmt: "Member Management", inviteEmail: "Email", inviteRole: "Role", invite: "Invite",
    currentMembers: "Current Members", langSetting: "Language", defaultLang: "Default Language",
    noProject: "No Projects", noProjectHint: "Create a new project or wait for an admin invitation",
    firstProject: "+ Create First Project",
    deleteProjConfirm: "Delete this project? All related data will also be deleted.",
    deleteConfirm: "Confirm delete?",
    roleLabel: "Role",
  },
  ko: {
    appName: "제작진 교통·숙박 관리 시스템",
    logout: "로그아웃", print: "인쇄", members: "멤버 관리", back: "뒤로",
    login: "로그인", loginTitle: "로그인하세요", loginEmail: "이메일", loginPw: "비밀번호", loginBtn: "로그인", loginHint: "접근 권한은 관리자의 초대로 부여됩니다",
    projects: "프로젝트 목록", newProject: "＋ 새 프로젝트", openProject: "열기 →", projectName: "프로젝트명", projectDesc: "설명 (선택)",
    create: "생성", creating: "생성 중…", cancel: "취소", save: "저장", saving: "저장 중…", edit: "편집", delete: "삭제", add: "＋ 추가",
    saved: "✓ 저장됨", deleted: "삭제됨",
    tabStaff: "👤 스태프 목록", tabFlight: "✈ 항공편 관리", tabHotel: "🏨 호텔 관리", tabHotelList: "📋 호텔 목록",
    staffList: "스태프 목록", flightMgmt: "✈ 항공편 관리", hotelMgmt: "호텔 관리", hotelList: "📋 호텔 목록",
    no: "번호", dept: "부서", nameKanji: "이름(한자)", nameRoman: "로마자 이름", importance: "중요도",
    status: "배정 상태", passport: "여권 번호", dob: "생년월일", passportExp: "여권 만료일", diet: "식이 제한", action: "작업",
    arranged: "✓ 완료", partial: "⚡ 일부 완료", unArranged: "— 미배정",
    passportWarn: "⚠ 만료 180일 미만",
    ...
    checkedBag: "위탁 수하물", cabinBag: "기내 수하물", flightDone: "✓ 완료", flightNone: "미배정",
    addFlight: "＋ 입력", editFlight: "편집",
    ...
    addHotelTitle: "호텔 추가", editHotelTitle: "호텔 편집",
    addRuleTitle: "요금 규칙 추가", editRuleTitle: "요금 규칙 편집",
    targetHotel: "대상 호텔",
    customRoomType: "사용자 정의 객실 유형",
    breakdownTitle: "일별 요금 내역",
    noData: "데이터 없음", searchPlaceholder: "검색…",
    searchStaff: "이름・부서・여권 검색…", searchFlight: "이름・항공사 검색…", searchHotel: "이름・호텔 검색…", searchHotelList: "호텔명・주소・전화 검색…",
    allDept: "전체 부서", role_admin: "관리자", role_editor: "편집자", role_viewer: "열람만",
    memberMgmt: "멤버 관리", inviteEmail: "이메일", inviteRole: "권한", invite: "초대",
    currentMembers: "현재 멤버", langSetting: "언어 설정", defaultLang: "기본 언어",
    noProject: "프로젝트 없음", noProjectHint: "새 프로젝트를 생성하거나 관리자 초대를 기다리세요",
    firstProject: "＋ 첫 프로젝트 생성",
    deleteProjConfirm: "이 프로젝트를 삭제하시겠습니까? 관련 데이터도 모두 삭제됩니다.",
      ...
      <div style={{ background: "white", borderRadius: 16, padding: 40, width: 360, boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
        ...
        <div style={{ marginBottom: 20 }}>
          <select value={lang} onChange={e => setLang(e.target.value)}
            style={{ width: "100%", border: "1px solid #d1d5db", borderRadius: 8, padding: "8px 12px", fontSize: 13, background: "white", color: "#374151", outline: "none", cursor: "pointer" }}>
...
function ProjectSelector({ user, lang, onLangChange, onSelect }) {
  ...
  const deleteProject = async (pid) => {
    if (!window.confirm("このプロジェクトを削除しますか？関連するすべてのデータも削除されます。")) return;
      ...
      <div style={{ background: "linear-gradient(135deg,#1e3a8a,#2563eb)", padding: "16px 24px", color: "white", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
          ...
          <button onClick={() => { api.logout(); window.location.reload(); }}
            style={{ background: "rgba(255,255,255,0.15)", color: "white", border: "1px solid rgba(255,255,255,.3)", borderRadius: 8, padding: "7px 14px", fontWeight: 600, cursor: "pointer", fontSize: 12 }}>🔒 {t.logout}</button>
        </div>
      </div>
        ...
        {loading ? <div style={{ textAlign: "center", padding: 40, color: "#9ca3af" }}>…</div> : (
          projects.length === 0 ? (
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(260px,1fr))", gap: 16 }}>
              {projects.map(up => (
                <div key={up.id} style={{ background: "white", borderRadius: 14, boxShadow: "0 2px 12px rgba(0,0,0,.08)", overflow: "hidden", transition: "transform .15s", cursor: "pointer" }}
                  ...
                  <div style={{ padding: "14px 20px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                      <span style={{ fontSize: 11, fontWeight: 700, padding: "3px 8px", borderRadius: 20, ...ROLE_COLORS[up.role] }}>
                        {t[`role_${up.role}`]}
                      </span>
                      <span style={{ fontSize: 11, color: "#9ca3af" }}>
                        {up.projects?.created_at ? new Date(up.projects.created_at).toLocaleDateString() : ""}
                      </span>
                    </div>
...
// ─── Member Manager ──────────────────────────────────────────
function MemberManager({ project, onClose }) {
  ...
  const load = async () => {
    const rows = await api.get("user_projects", `&project_id=eq.${project.id}&select=*`);
    setMembers(rows);
  };
  useEffect(() => { load(); }, []);
  ...
  const invite = async () => {
    ...
    try {
      ...
      showToast("招待メールを送信するにはSupabase側で操作が必要です。ユーザーIDを直接入力してください。");
    } catch (e) { showToast("エラー: " + e.message); }
    setSaving(false);
  };
  ...
  const changeRole = async (id, newRole) => {
    ...
    load(); showToast("✓ 権限を更新しました");
  };

  const removeMember = async (id) => {
    if (!window.confirm("このメンバーを削除しますか？")) return;
    await api.delete("user_projects", id);
    load(); showToast("削除しました");
  };

  return (
    <Modal title={`メンバー管理 — ${project.name}`} onClose={onClose} wide>
      {toast && <div style={{ background: "#dbeafe", color: "#1d4ed8", borderRadius: 8, padding: "8px 12px", fontSize: 13, marginBottom: 14 }}>{toast}</div>}
      <div style={{ marginBottom: 20, padding: 16, background: "#f8fafc", borderRadius: 10 }}>
        <div style={{ fontWeight: 700, fontSize: 13, color: "#374151", marginBottom: 10 }}>メンバーを招待</div>
        <div style={{ display: "flex", gap: 8 }}>
          <input className={inp} value={email} onChange={e => setEmail(e.target.value)} placeholder="メールアドレス" style={{ flex: 2 }} />
          <select value={role} onChange={e => setRole(e.target.value)}
            style={{ border: "1px solid #d1d5db", borderRadius: 8, padding: "7px 10px", fontSize: 13, background: "white" }}>
            <option value="editor">編輯</option>
            <option value="viewer">唯讀</option>
            <option value="admin">管理員</option>
          </select>
          <button onClick={invite} style={{ background: "#2563eb", color: "white", border: "none", borderRadius: 8, padding: "8px 16px", fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap" }}>招待</button>
        </div>
        <p style={{ fontSize: 11, color: "#9ca3af", marginTop: 8 }}>※ 招待にはSupabase AuthenticationページでユーザーをInviteしてから、そのユーザーIDを登録してください</p>
      </div>
      <div style={{ fontWeight: 700, fontSize: 13, color: "#374151", marginBottom: 10 }}>現在のメンバー ({members.length}名)</div>
      {members.map(m => (
        <div key={m.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 14px", background: "white", borderRadius: 10, border: "1px solid #e5e7eb", marginBottom: 8 }}>
          <div style={{ fontSize: 13, color: "#374151", flex: 1 }}>
            <span style={{ fontWeight: 600 }}>UserID: </span>
            <span style={{ fontFamily: "monospace", fontSize: 11, color: "#6b7280" }}>{m.user_id}</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <select value={m.role} onChange={e => changeRole(m.id, e.target.value)}
              style={{ border: "1px solid #d1d5db", borderRadius: 6, padding: "4px 8px", fontSize: 12, background: "white" }}>
              <option value="admin">管理員</option>
              <option value="editor">編輯</option>
              <option value="viewer">唯讀</option>
            </select>
            <button onClick={() => removeMember(m.id)} style={dBtn}>削除</button>
          </div>
        </div>
      ))}
    </Modal>
    ...
    <div>
      <div className="grid grid-cols-2 gap-3">
        ...
        <Field label="パスポート有効期限">
          ...
          {passportWarning(f.passport_exp) && <p style={{ color: "red", fontSize: 11, marginTop: 4 }}>⚠ 残り180日未満</p>}
        </Field>
  ...
  return (
    <div>
      <div className="grid grid-cols-2 gap-3">
        ...
        <Field label="搭乗クラス"><select className={inp} value={f.cabin} onChange={set("cabin")}>{CABIN.map(c => <option key={c}>{c}</option>)}</select></Field>
        <Field label="PNR"><input className={inp} value={f.pnr} onChange={set("pnr")} /></Field>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 16 }}>
        <button onClick={onClose} style={{ padding: "8px 16px", borderRadius: 8, border: "1px solid #d1d5db", cursor: "pointer" }}>キャンセル</button>
        <button onClick={() => onSave(f)} style={{ background: "#2563eb", color: "white", border: "none", borderRadius: 8, padding: "8px 18px", fontWeight: 700, cursor: "pointer" }}>保存</button>
      </div>
    </div>
  );
}
  ...
  return (
    <div>
      <div className="grid grid-cols-2 gap-3">
        ...
        <Field label="Room Type"><select className={inp} value={f.room_type} onChange={set("room_type")}>{ROOM_TYPES.map(r => <option key={r}>{r}</option>)}</select></Field>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 16 }}>
        <button onClick={onClose} style={{ padding: "8px 16px", borderRadius: 8, border: "1px solid #d1d5db", cursor: "pointer" }}>キャンセル</button>
        <button onClick={() => onSave({ ...f, nights, total_amount: totalAmount })} style={{ background: "#2563eb", color: "white", border: "none", borderRadius: 8, padding: "8px 18px", fontWeight: 700, cursor: "pointer" }}>保存</button>
      </div>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Field label="Room Type"><select className={inp} value={f.room_type} onChange={set("room_type")}>{ROOM_TYPES.map(r => <option key={r}>{r}</option>)}</select></Field>
        {f.room_type === "Custom" && <Field label="Custom Type"><input className={inp} value={f.room_custom} onChange={set("room_custom")} /></Field>}
        ...
        <Field label="節日加算 ($)"><input type="number" className={inp} value={f.holiday_surcharge} onChange={set("holiday_surcharge")} /></Field>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 16 }}>
        <button onClick={onClose} style={{ padding: "8px 16px", borderRadius: 8, border: "1px solid #d1d5db", cursor: "pointer" }}>キャンセル</button>
        <button onClick={() => onSave({ ...f, hotel_id: hotelId, final_price: final })} style={{ background: "#2563eb", color: "white", border: "none", borderRadius: 8, padding: "8px 18px", fontWeight: 700, cursor: "pointer" }}>保存</button>
      </div>
    </div>
  );
}
...
function RoommateModal({ pid, persons, roommates, onSave, onClose }) {
  ...
  return (
    <Modal title={`同室設定 — ${person?.name_kanji}`} onClose={onClose}>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 16 }}>
        <button onClick={onClose} style={{ padding: "8px 16px", borderRadius: 8, border: "1px solid #d1d5db", cursor: "pointer" }}>キャンセル</button>
        <button onClick={() => onSave(pid, selected)} style={{ background: "#2563eb", color: "white", border: "none", borderRadius: 8, padding: "8px 18px", fontWeight: 700, cursor: "pointer" }}>保存</button>
      </div>
    </Modal>
  );
}
...
function ProjectApp({ project, userRole, user, lang, onLangChange, onBack }) {
  ...
  const saveRoommates = async (rpid, partnerIds) => {
    try {
      ...
      await loadAll(); showToast("✓ 同室設定を保存しました"); setRoommateModal(null);
    } catch (e) { showToast("エラー: " + e.message); }
  };
  ...
  return (
    <div style={{ fontFamily: "system-ui,sans-serif", minHeight: "100vh", background: "#f0f4f8" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 11, opacity: .75 }}>
              ☁ {user.email} ·
              <span style={{ marginLeft: 6, padding: "1px 6px", borderRadius: 10, background: "rgba(255,255,255,0.2)", fontSize: 10 }}>{t[`role_${userRole}`]}</span>
            </div>
          </div>
        </div>
        <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
      ...
      {loading ? <div style={{ textAlign: "center", padding: 40, color: "#6b7280" }}>☁ データを読み込んでいます…</div> : (
                      ...
                      {rows.map((p, i) => {
                        ...
                        return (
                          <tr key={p.id}>
                            ...
                            <td style={tdS(i)}>
                              {(() => { const s = getStatus(p.id); return s === "arranged" ? <span style={{ padding: "2px 8px", borderRadius: 20, background: "#d1fae5", color: "#065f46", fontSize: 11, fontWeight: 700 }}>{t.arranged}</span> : s === "partial" ? <span style={{ padding: "2px 8px", borderRadius: 20, background: "#fef3c7", color: "#92400e", fontSize: 11, fontWeight: 700 }}>{t.partial}</span> : <span style={{ padding: "2px 8px", borderRadius: 20, background: "#f3f4f6", color: "#9ca3af", fontSize: 11 }}>{t.unArranged}</span>; })()}
                            </td>
          ...
          {tab === "B" && (() => {
            ...
            return (
              <div>
                ...
                <div style={{ overflowX: "auto" }}>
                  <table style={tblW}>
                    <thead><tr style={thead}>{["No", "部門", "名前", "ローマ字", "航空会社", "便名", "Class", "PNR", "出発", "出発時刻", "到着", "到着時刻", "手荷物", "状況", "操作"].map(h => <th key={h} style={thS}>{h}</th>)}</tr></thead>
                    <tbody>
                      {rows.map((p, i) => {
                        ...
                        return (
                          <tr key={p.id}>
                            ...
                            <td style={tdS(i)}>{f?.dep_time ? new Date(f.dep_time).toLocaleString("ja-JP", { month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit" }) : "—"}</td>
                            <td style={tdS(i)}>{f ? `${f.arr_airport}${f.arr_terminal ? " T" + f.arr_terminal : ""}` : "—"}</td>
                            <td style={tdS(i)}>{f?.arr_time ? new Date(f.arr_time).toLocaleString("ja-JP", { month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit" }) : "—"}</td>
                            <td style={tdS(i)}>{f ? `預${f.checked_bag || "—"}/手${f.cabin_bag || "—"}` : "—"}</td>
                            <td style={tdS(i)}>{hasF ? <span style={{ padding: "2px 8px", borderRadius: 20, background: "#d1fae5", color: "#065f46", fontSize: 11, fontWeight: 700 }}>✓ 手配済</span> : <span style={{ padding: "2px 8px", borderRadius: 20, background: "#f3f4f6", color: "#9ca3af", fontSize: 11 }}>未手配</span>}</td>
                            <td style={{ ...tdS(i), whiteSpace: "nowrap" }}>
                              {canEdit && <button style={aBtn} onClick={() => setFlightModal({ pid: p.id, data: f || null })}>{hasF ? "編集" : "＋ 入力"}</button>}
                            </td>
                          </tr>
                        );
                      })}
            ...
            return (
              <div>
                ...
                <div style={{ overflowX: "auto", marginBottom: 28 }}>
                  <table style={tblW}>
                    <thead><tr style={thead}>{["No", "部門", "名前", "ホテル", "Room Type", "チェックイン", "チェックアウト", "泊数", "合計 ($)", "同室者", "状況", "操作"].map(h => <th key={h} style={thS}>{h}</th>)}</tr></thead>
                    <tbody>
                      {rows.map((p, i) => {
                        ...
                        return (
                          <tr key={p.id}>
                            ...
                            <td style={tdS(i)}>{getRoommateNames(p.id) ? <span style={{ fontSize: 11, background: "#fef3c7", color: "#92400e", borderRadius: 4, padding: "2px 7px" }}>🛏 {getRoommateNames(p.id)}</span> : <span style={{ fontSize: 11, color: "#9ca3af" }}>個室</span>}</td>
                            <td style={tdS(i)}>{hasS ? <span style={{ padding: "2px 8px", borderRadius: 20, background: "#d1fae5", color: "#065f46", fontSize: 11, fontWeight: 700 }}>✓ 手配済</span> : <span style={{ padding: "2px 8px", borderRadius: 20, background: "#f3f4f6", color: "#9ca3af", fontSize: 11 }}>未手配</span>}</td>
                            <td style={{ ...tdS(i), whiteSpace: "nowrap" }}>
                              {canEdit && <><button style={aBtn} onClick={() => setStayModal({ pid: p.id, data: s || null })}>{hasS ? "編集" : "＋ 入力"}</button>
                      ...
                      return (
                        <div key={h.id} style={{ background: "white", borderRadius: 12, padding: 16, boxShadow: "0 2px 8px rgba(0,0,0,.08)", borderLeft: "4px solid #2563eb" }}>
                          ...
                          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, textAlign: "center" }}>
                            <div style={{ background: "#eff6ff", borderRadius: 8, padding: "8px 4px" }}><div style={{ fontSize: 20, fontWeight: 900, color: "#2563eb" }}>{st.guests}</div><div style={{ fontSize: 10, color: "#6b7280" }}>入住人数</div></div>
                            <div style={{ background: "#f0fdf4", borderRadius: 8, padding: "8px 4px" }}><div style={{ fontSize: 20, fontWeight: 900, color: "#16a34a" }}>{st.rooms}</div><div style={{ fontSize: 10, color: "#6b7280" }}>客室数</div></div>
                            <div style={{ background: "#fefce8", borderRadius: 8, padding: "8px 4px" }}><div style={{ fontSize: 14, fontWeight: 900, color: "#ca8a04" }}>${st.total.toLocaleString()}</div><div style={{ fontSize: 10, color: "#6b7280" }}>総費用</div></div>
                          </div>
                        </div>
                      );
                    })}
                      ...
                      <div key={h.id} style={{ background: "white", borderRadius: 12, boxShadow: "0 2px 8px rgba(0,0,0,.08)", overflow: "hidden" }}>
                        <div style={{ borderLeft: "4px solid #2563eb", padding: "14px 16px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                          ...
                          {canEdit && <div style={{ display: "flex", gap: 8, marginLeft: 12 }}>
                            <button style={eBtn} onClick={() => setHotelModal({ mode: "edit", data: h })}>編集</button>
                            <button style={dBtn} onClick={() => deleteHotel(h.id)}>削除</button>
                          </div>}
                        </div>
                          ...
                          {hRules.length === 0 ? <p style={{ color: "#9ca3af", fontSize: 12, margin: 0 }}>料金ルールはまだ設定されていません。</p> : (
                            <div style={{ overflowX: "auto" }}>
                              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                                <thead><tr style={{ background: "#e5e7eb" }}>{["日付", "Room Type", "基本", "重要度+", "節日+", "最終料金", "操作"].map(l => <th key={l} style={{ padding: "6px 10px", textAlign: "left", fontWeight: 600 }}>{l}</th>)}</tr></thead>
                                <tbody>
                                  {hRules.map(r => (
                                    <tr key={r.id} style={{ borderBottom: "1px solid #e5e7eb" }}>
                                      ...
                                      {canEdit && <td style={{ padding: "6px 10px", whiteSpace: "nowrap" }}>
                                        <button style={eBtn} onClick={() => setPriceModal({ mode: "edit", data: r, hotelId: h.id, hotelName: h.name })}>編集</button>
                                        <button style={dBtn} onClick={() => deletePricing(r.id)}>削除</button>
                                      </td>}
                                    </tr>
                                  ))}
                                </tbody>
      ...
      {flightModal && <Modal title={`フライト — ${persons.find(p => p.id === flightModal.pid)?.name_kanji || ""}`} onClose={() => setFlightModal(null)}><FlightForm init={flightModal.data} onSave={saveFlight} onClose={() => setFlightModal(null)} /></Modal>}
      {stayModal && <Modal title={`ホテル — ${persons.find(p => p.id === stayModal.pid)?.name_kanji || ""}`} onClose={() => setStayModal(null)}><HotelStayForm init={stayModal.data} hotels={hotels} pricingRules={pricingRules} onSave={saveStay} onClose={() => setStayModal(null)} /></Modal>}
      ...
      {showMembers && <MemberManager project={project} onClose={() => setShowMembers(false)} />}
